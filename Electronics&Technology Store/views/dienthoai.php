...
<body>
    <div class="item-container">
        ...
        $item_total = getProductByCategory(2);
        $products = getProductHaveLimit(2, $start, $limit);
        ...
        ?>
            <div class="img-card border text-center" id="item-js">
                ...
                <button id="m" type="submit" class="cart-btn type1 mx-3">
                </button>
                <form action="../product/product_process.php" method="post">
